...
class TeacherView(APIView):
    ...
    def post(self, request):
        ...
        user = User.objects.create(username=request.data['username'],name=request.data['username'],uid=uid,password=hashed_password,role='teacher',email=email,address='')
...
class TeacherBatchDeleteAPIView(APIView):
    def post(self, request):
        ids = request.data
        try:
...
class TeacherExport(APIView):
    ...
    def get(self, request, *args, **kwargs):
        ...
        model = apps.get_model('business','Teacher')
