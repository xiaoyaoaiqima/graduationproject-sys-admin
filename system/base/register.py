    ...
    def post(self, request):
        ...
        if (serializer.is_valid()):
            ...
            if request.data['role'] == 'student':
                Student.objects.create(username=request.data['username'],user_id=user.id,name=name)
            if request.data['role'] == 'teacher':
                Teacher.objects.create(username=request.data['username'],user_id=user.id,name=name)
